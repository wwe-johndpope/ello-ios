    ...
    override func spec() {
        ...
        describe("toggleButtonTapped") {
            ...
            it("calls the delegate function") {
                ...
                let setting = DynamicSetting(label: "", key: "", dependentOn: [], conflictsWith: [], setsAnother: [], info: "", linkLabel: "", linkURL: .None)
            ...
            it("hands the setting and value to the delegate function") {
                let fake = FakeDelegate()
                let setting = DynamicSetting(label: "test", key: "", dependentOn: [], conflictsWith: [], setsAnother: [], info: "", linkLabel: "", linkURL: .None)
                subject.delegate = fake
                subject.setting = setting
                subject.toggleButtonTapped()
