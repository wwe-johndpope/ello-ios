        ...
        describe("StreamCellType") {
            ...
            let expectations: [(
                ...
                collapsable: Bool)] = [
                    ...
                    (".editorial", type: .editorial(.post), name: Editorial.Kind.post.reuseIdentifier, selectable: false, classType: EditorialPostCell.self, oneColumnHeight: 0, multiColumnHeight: 0, isFullWidth: true, collapsable: false),
