        ...
        describe("StreamCellType") {
            ...
            let expectations: [(
                ...
                isCollapsable: Bool)] = [
                    ...
                    (".editorial", type: .editorial(.post), name: Editorial.Kind.post.reuseIdentifier, isSelectable: true, classType: EditorialPostCell.self, oneColumnHeight: 376, multiColumnHeight: 376, isFullWidth: true, isCollapsable: false),
