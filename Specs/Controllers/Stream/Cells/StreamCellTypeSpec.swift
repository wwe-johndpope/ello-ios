        ...
        describe("StreamCellType") {
            ...
            let expectations: [(
                ...
                collapsable: Bool)] = [
                    ...
                    (".streamFooter", type: .streamFooter, name: StreamFooterCell.reuseIdentifier, selectable: false, classType: StreamFooterCell.self, oneColumnHeight: 44, multiColumnHeight: 44, isFullWidth: false, collapsable: false),
                    (".streamHeader", type: .streamHeader, name: StreamHeaderCell.reuseIdentifier, selectable: true, classType: StreamHeaderCell.self, oneColumnHeight: 70, multiColumnHeight: 60, isFullWidth: false, collapsable: false),
                    ...
                    (".header", type: .header(nil), name: TextHeaderCell.reuseIdentifier, selectable: false, classType: TextHeaderCell.self, oneColumnHeight: 75, multiColumnHeight: 75, isFullWidth: true, collapsable: false),
                    (".tallHeader", type: .tallHeader(nil), name: TextHeaderCell.reuseIdentifier, selectable: false, classType: TextHeaderCell.self, oneColumnHeight: 75, multiColumnHeight: 75, isFullWidth: true, collapsable: false),
