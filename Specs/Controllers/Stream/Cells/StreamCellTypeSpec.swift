        ...
        describe("StreamCellType") {
            ...
            let expectations: [(
                ...
                isCollapsable: Bool)] = [
                    ...
                    (".categoryPromotionalHeader", type: .categoryPromotionalHeader, name: PromotionalHeaderCell.reuseIdentifier, isSelectable: false, classType: PromotionalHeaderCell.self, oneColumnHeight: 150, multiColumnHeight: 150, isFullWidth: true, isCollapsable: false),
                    ...
                    (".pagePromotionalHeader", type: .pagePromotionalHeader, name: PromotionalHeaderCell.reuseIdentifier, isSelectable: false, classType: PromotionalHeaderCell.self, oneColumnHeight: 150, multiColumnHeight: 150, isFullWidth: true, isCollapsable: false),
